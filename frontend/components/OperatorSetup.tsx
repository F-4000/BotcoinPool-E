...
function envTemplate(poolAddress: string, llmProvider: string): string {
  return [
    ...
    "# ── Required ──",
    "",
    "# Bankr API key (https://bankr.bot/terminal)",
    ...
    "# ── Optional ──",
    "",
    "# Override default model (gpt-4o / claude-sonnet-4-20250514)",
    "# LLM_MODEL=gpt-4o",
    "",
    "# Max tokens for solver response (default: 4096)",
    "# LLM_MAX_TOKENS=4096",
    "",
    "# Coordinator API (default: https://coordinator.agentmoney.net)",
    "# COORDINATOR_URL=https://coordinator.agentmoney.net",
    "",
    "# Bankr API URL (default: https://api.bankr.bot)",
    "# BANKR_URL=https://api.bankr.bot",
    "",
    "# Mining loop delay in ms (default: 5000)",
    "# LOOP_DELAY_MS=5000",
    "",
    "# Stop after N consecutive failures (default: 5)",
    "# MAX_CONSECUTIVE_FAILURES=5",
    "",
    "# Auth token refresh buffer in seconds (default: 60)",
    "# AUTH_REFRESH_BUFFER=60",
    "",
