...
export default function Header() {
  ...
  return (
    <header className="bg-surface/95 sticky top-0 z-100 border-b border-border">
      <div className="glow-separator absolute bottom-0 left-0 right-0" />
              ...
              return (
                <div className="relative" ref={menuRef}>
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-lg bg-card border border-border hover:border-base-blue/25 transition-all text-sm text-text"
                  >
                  ...
                  {menuOpen && (
                    <div className="absolute right-0 top-full mt-2 w-56 rounded-xl bg-card border border-border p-2 shadow-xl shadow-black/40 z-200">
