  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <Section title="Contract Addresses">
        <div className="space-y-2">
          <AddrRow label="FactoryV2" addr="0x71B9716A0A90Ae67B5CEf426da30F6D5D3ba6EeC" />
      ...
      <div className="glass-card p-5 flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-4 text-xs">
          ...
          <a href="https://basescan.org/address/0x71B9716A0A90Ae67B5CEf426da30F6D5D3ba6EeC#code" target="_blank" rel="noopener noreferrer"
